...
## 📚Blog
这是一个兼具博客文章、知识管理、文档查找的个人网站，主要内容是Web前端技术。如果你喜欢这个博客欢迎到 [GitHub](https://github.com/jywangyou/notes-blog)点个 Star，或者交换[友链](/friends/) ( •̀ ω •́ )✧

:::tip
文章内容仅是我个人的小总结，资历尚浅，如有误还请指正。
:::

[更新日志](https://github.com/jywangyou/notes-blog/commits/master)
...
## @Me
在下前端衰仔一名，年满十八，遵纪守法，爱国爱家，不碰烟酒

### 技能
* 熟悉 JavaScript、HTML、CSS、Vue、React 的拼写
* 了解 Linux、windows、macOS 的开关机方式
* 掌握 Oracle、SqlServer、MySQL、MongoDB 的连接与断开
* 略懂 C#、Java、Node.js 的拼读
...
- Email:  <a href="mailto:2712334479@qq.com">2712334479@qq.com</a>
- GitHub: <https://github.com/jywangyou>
