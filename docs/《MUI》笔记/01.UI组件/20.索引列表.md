---
title: 索引列表
date: 2023-12-06 10:55:49
permalink: /pages/b4fd79/
categories:
  - 《MUI》笔记
  - UI组件
tags:
...
<mark>mui.min.css</mark> <mark>mui.indexedlist.css</mark>

<mark>mui.min.js</mark> <mark>mui.indexedlist.js</mark>
...
像下面示例代码中DOM的属性`data-group`的值是对应的索引，`data-value`是内容文本的缩写，`data-tags`是内容文本的全拼.

所有准备就绪后需要`设置索引容器的高`.

> 如果是动态渲染的，在渲染结束后要重新初始化索引列表

[预览地址](https://www.dcloud.io/hellomui/examples/indexed-list.html)

官方完整示例：

```html {8-9,29,33,65-66,250-251,258,260}
<!DOCTYPE html>
<html>
